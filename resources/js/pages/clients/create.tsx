      ...
      <div className="flex h-full flex-1 flex-col gap-4 p-2 sm:p-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-0">
          <Link href={route("clients.index")}>
            <Button
              variant="ghost"
              size="sm"
              className="mr-0 sm:mr-4 flex items-center gap-1"
            >
        ...
        <Card className="border border-neutral-200 bg-white dark:border-neutral-700 dark:bg-neutral-900">
          <CardHeader>
            ...
            <CardDescription>
              Complete la información necesaria para crear un nuevo cliente. Todos
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  {form.errors.document && (
                    <p className="text-sm text-red-500">{form.errors.document}</p>
                  )}
                </div>
                <div className="space-y-2">
