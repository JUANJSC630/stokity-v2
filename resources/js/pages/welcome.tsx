            ...
            <div className="flex min-h-screen flex-col items-center justify-center bg-[#f7f8fa] p-6 dark:bg-gray-900">
                <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-lg dark:bg-gray-800">
                    <div className="mb-8 text-center">
                        ...
                        <h1 className="mb-2 inline-block text-3xl font-bold font-serif text-gray-700">
                            {businessName}
                        </h1>
                        ...
                        <div className="mt-6 flex justify-center">
                            {auth.user ? (
                                <Link
                                    ...
                                    style={{ background: 'linear-gradient(90deg, #C850C0 0%, #FFCC70 100%)', boxShadow: '0 6px 18px 0 rgba(200,80,192,0.2)' }}
                                >
                                    Dashboard
                                </Link>
                            ) : (
