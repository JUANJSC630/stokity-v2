        ...
        <div className="flex h-full flex-1 flex-col gap-4 p-4">
          <div className="flex items-center justify-center h-full">
            <div className="text-center">
              <h1 className="text-2xl font-semibold text-red-600 mb-4">Producto no encontrado</h1>
              <p className="text-gray-600 mb-4">El producto que buscas no existe o no tienes permisos para verlo.</p>
              <pre className="text-xs bg-gray-100 p-2 rounded mt-2">
                {JSON.stringify({ product, movements }, null, 2)}
              </pre>
              <Link href="/products">
    ...
    return (
      <AppLayout breadcrumbs={[]}>
        ...
        <div className="flex h-full flex-1 flex-col gap-4 p-4">
          <div className="flex items-center justify-center h-full">
            <div className="text-center">
              <h1 className="text-2xl font-semibold text-red-600 mb-4">Error en datos del producto</h1>
