                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                ...
                                />
                                {getQuantityHelp() && <p className="mt-1 text-sm text-neutral-600 dark:text-neutral-400">{getQuantityHelp()}</p>}
                            ...
                            {movementType === 'in' && (
                                <div>
                                    ...
                                    <Input
                                        ...
                                        placeholder="0.00"
                                    />
                                    <p className="mt-1 text-sm text-neutral-600 dark:text-neutral-400">Precio de compra por unidad (opcional)</p>
                            ...
                            <div>
                                ...
                                />
                                <p className="mt-1 text-sm text-neutral-600 dark:text-neutral-400">Motivo o referencia del movimiento</p>
                            ...
                            <div>
                                ...
                                />
                                {errors.movement_date && <p className="mt-1 text-sm text-red-600">{errors.movement_date}</p>}
                            </div>
